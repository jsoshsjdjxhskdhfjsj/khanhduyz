...
spawn(function()
    ...
    DropdownMaterial:SetValue("Please Choose item")
...
Tabs.Player:AddToggle("SkillAimbot", {Title = "Aimbot", Default = false })
Tabs.Player:AddToggle("KillNearPlayer", {Title = "Kill Near Player", Default = false })
