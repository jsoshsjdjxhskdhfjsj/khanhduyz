...
local Tabs = {
    ...
    Fruit = Window:AddTab({ Title = "Tab DF" }),
...
ImageButton.Image = "rbxassetid://16356342838"
...
for _,v in next, workspace.Boats.MarineBrigade:GetDescendants() do
 ...
 local AutoW = Tabs.Main:AddToggle("AutoW", {Title = "Auto W", Default = false })
...
_G.FastAttackDelay = 0.15
    ...
    local ToggleSuperFastAttack = Tabs.Setting:AddToggle("ToggleSuperFastAttack", {Title = "Super Fast Attack", Default = false })
    ToggleSuperFastAttack:OnChanged(function(vu)
        SuperFastAttack = vu
    end)
    Options.ToggleSuperFastAttack:SetValue(true)
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = "Remove Dame Text", Default = false })
...
--------------------------------------------------------------------------------------------------------------------------------------------
--Tab Stats
local ToggleMelee = Tabs.Stats:AddToggle("ToggleMelee", {Title = "Stat Melee", Default = false })
...
local ToggleDe = Tabs.Stats:AddToggle("ToggleDe", {Title = "Stat Defense", Default = false })
...
local ToggleSword = Tabs.Stats:AddToggle("ToggleSword", {Title = "Stat Sword", Default = false })
...
Tabs.Shop.AddButton({
    Title = "Use Ghoul Race",
    Description = "Only have race ghoul",
    Callback = function()
        game:GetService("ReplicatedStore").Remotes.CommF_:InvokeServer("BlackbeardReward","Change Ghoul","1")
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Change Ghoul","2")
	end
})
--------------------------------------------------------------------------------------------------------------------------------------------
--misc
